# https://launchschool.com/exercises/4044b772

# A friend of yours wants to build a basic search engine and 
# starts reading up on information extraction. He decides to try a
# simple implementation of TF-IDF, a measure of the information content 
# a term holds for a particular document in a document collection. 
# However, he just started learning to code and somehow his numbers 
# do not match what is expected. He knows you're enrolled in an awesome 
